...
function buildCsp(nonce: string): string {
  return [
    ...
    "img-src 'self' data: blob: https://*.supabase.co https://pagead2.googlesyndication.com https://*.google.com https://*.doubleclick.net https://*.adtrafficquality.google https://*.google-analytics.com https://assets.nhle.com https://www.mlbstatic.com",
    "font-src 'self'",
...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|manifest.webmanifest|images/|api/|auth/callback|.*\\.(?:svg|png|jpg|jpeg|gif|webp|txt|xml|ico|webmanifest)$).*)',
  ],
};
