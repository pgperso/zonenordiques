...
export function messageToFeedItem(row: ChatMessageWithJoin): FeedMessage {
  return {
    ...
    surpriseCount: row.surprise_count ?? 0,
        ...
        messages: state.messages.map((msg) =>
          msg.id !== u.id
            ...
            : {
                ...
                surpriseCount: (u as unknown as { surprise_count?: number }).surprise_count ?? msg.surpriseCount,
