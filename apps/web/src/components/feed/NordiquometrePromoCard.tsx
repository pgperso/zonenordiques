...
// A chat_message whose content is this sentinel is rendered as the
// Nordiquomètre promo card (see FeedItem). Posted by the staff-only "/meter"
// slash command.
export const NORDIQUOMETRE_PROMO_SENTINEL = '::nordiquometre-promo::';

interface NordiquometrePromoCardProps {
  messageId: number;
  userId: string | null;
  canModerate?: boolean;
}

export function NordiquometrePromoCard({ messageId, userId, canModerate }: NordiquometrePromoCardProps) {
  const t = useTranslations('nordiquometrePromo');
    ...
    <div className="px-4 py-3">
      ...
      >
        ...
        <div className="relative h-40 w-full">
          ...
          />
          {/* Flat tint unifies banner mood across photos of different
