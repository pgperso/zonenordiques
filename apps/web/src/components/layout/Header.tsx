            ...
            {tribune ? (
              <>
                ...
                <div className="hidden md:block">
                  ...
                  <p className="text-[10px] leading-tight tracking-[0.2em] text-gray-900 dark:text-gray-100"><span className="font-bold text-brand-red">{t('brand.taglineLead')}</span>{t('brand.taglineRest')}</p>
                </div>
              </>
            ) : (
              <div>
                ...
                <p className="hidden text-[10px] leading-tight tracking-[0.2em] text-gray-900 dark:text-gray-100 sm:block"><span className="font-bold text-brand-red">{t('brand.taglineLead')}</span>{t('brand.taglineRest')}</p>
              </div>
            )}
          </Link>
        </div>
