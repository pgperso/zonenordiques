            ...
            {tribune ? (
              <>
                ...
                <div className="hidden md:block">
                  ...
                  <p className="text-[10px] leading-tight tracking-wide text-gray-900 dark:text-gray-100">{t('brand.tagline')}</p>
                </div>
              </>
            ) : (
              <div>
                ...
                <p className="hidden text-[10px] leading-tight tracking-wide text-gray-900 dark:text-gray-100 sm:block">{t('brand.tagline')}</p>
              </div>
            )}
          </Link>
        </div>
